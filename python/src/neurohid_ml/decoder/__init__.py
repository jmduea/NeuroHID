...
class DecoderConfig:
    ...
    hidden_dims: List[int] | None = None  # Hidden layer sizes (default: [64, 64])
...
class PolicyNetwork(nn.Module):
    ...
    def __init__(self, config: DecoderConfig):
        ...
        hidden_dims = config.hidden_dims or []
    ...
    def get_action(
        ...
        continuous_log_prob = (
            torch.distributions.Normal(continuous_mean, continuous_log_std.exp())
            .log_prob(continuous_action)
            .sum(dim=-1)
        )
