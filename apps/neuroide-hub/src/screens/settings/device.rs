    ...
    let changed = egui::CollapsingHeader::new("Device")
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                let builtin = ["Auto", "LSL", "Mock", "Serial", "BrainFlow"];
            ...
            if matches!(
                ...
                ui.horizontal(|ui| {
                    ...
                    if theme::drag_value(ui, &mut bf_cfg.board_id, i32::MIN..=i32::MAX, 1.0, None) {
                        changed = true;
                    }
                });
                ui.horizontal(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if theme::text_input(
                    ...
                    cfg.preferred_device_type = if dtype.is_empty() { None } else { Some(dtype) };
                    changed = true;
                }
            });
