...
impl TargetTrackingGame {
    ...
    fn show_tracking(&self, ctx: &egui::Context) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            // Progress bar
            ui.add(egui::ProgressBar::new(self.elapsed_time / self.game_duration)
                .text(format!("{:.0}%", 100.0 * self.elapsed_time / self.game_duration)));
    ...
    fn draw_tracking_area(&self, ui: &mut egui::Ui) {
        ...
        painter.circle_filled(target_screen, target_radius, egui::Color32::from_rgb(50, 200, 100));
        painter.circle_stroke(target_screen, target_radius, egui::Stroke::new(2.0, egui::Color32::WHITE));
        ...
        painter.circle_stroke(cursor_screen, cursor_radius, egui::Stroke::new(2.0, egui::Color32::WHITE));
