...
Plans:
- [x] 06-01-PLAN.md — All four slot contracts (outlet, device, signal preprocessing, decoder), extension manifest, discovery registry (COMP-06, EXT-01, EXT-02)
- [x] 06-02-PLAN.md — Device, signal preprocessing, decoder, outlet name-based selection and loading in core (COMP-06, EXT-01, EXT-02)
